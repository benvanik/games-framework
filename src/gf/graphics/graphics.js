...
/**
 * @fileoverview Utilities and constants for the graphics system.
 *
 * @author benvanik@google.com (Ben Vanik)
 */

goog.provide('gf.graphics');


/**
 * @define {boolean} True to use compiled shaders (vs. uncompiled/unobfuscated)
 * shaders. Debugging may be more difficult when using compiled shaders, so
